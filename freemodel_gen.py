...
Usage: python freemodel_gen.py "a red apple" -q high -n 2 -s 2048x2048
"""
...
def load_tokens():
    ...
    if not tokens:
        try:
            ...
            pass
    if not tokens:
        raise SystemExit("Set FREEMODEL_TOKEN environment variable or create a .env file")
    return tokens
...
if __name__ == "__main__":
    import argparse
    ap = argparse.ArgumentParser(description="freemodel.dev image generation")
